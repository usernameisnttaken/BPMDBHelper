...
import ru.ertelecom.bpms.db.dao.LSWBPDInstanceDataDAO;
 ...
 */
public class LSWBPDInstanceDataService {
    public static final DateFormat ISO8601 = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm'Z'");
    private static final ObjectMapper OBJECT_MAPPER = new ObjectMapper();

    private final LSWBPDInstanceDataDAO LSWBPDInstanceDataDAO = new LSWBPDInstanceDataDAO();

    public LSWBPDInstanceDataService() {
    }

    public LSWBPDInstanceData findByBpdInstanceId(Long bpdInstanceId) {
        return LSWBPDInstanceDataDAO.findByBpdInstanceId(bpdInstanceId);
    }
